...
public class ColorPanelView extends View {
    ...
    private cn.qqtheme.framework.widget.ColorPanelView mBrightnessGradientView;
    ...
    public interface OnColorChangedListener {
         ...
         */
        void onColorChanged(cn.qqtheme.framework.widget.ColorPanelView view, int color);
    }
     ...
     */
    public void setBrightnessGradientView(cn.qqtheme.framework.widget.ColorPanelView brightnessGradient) {
...
//required field that makes Parcelables from a Parcel
        public static final Creator<SavedState> CREATOR =
                new Creator<SavedState>() {
                    public cn.qqtheme.framework.widget.ColorPanelView.SavedState createFromParcel(Parcel in) {
                        return new cn.qqtheme.framework.widget.ColorPanelView.SavedState(in);
                    }

                    public cn.qqtheme.framework.widget.ColorPanelView.SavedState[] newArray(int size) {
                        return new cn.qqtheme.framework.widget.ColorPanelView.SavedState[size];
                    }
                };
    }
