...
public final class FileUtils {
    ...
    public static File[] listDirs(String startDirPath, String[] excludeDirs, @SortType int sortType) {
        ...
        for (File dir : dirs) {
            ...
            if (!cn.qqtheme.framework.util.ConvertUtils.toString(excludeDirs).contains(file.getName())) {
                dirList.add(file);
            }
        }
    ...
    public static File[] listFiles(String startDirPath, final String[] allowExtensions) {
        ...
        return file.listFiles(new FilenameFilter() {
            ...
            public boolean accept(File dir, String name) {
                //返回当前目录所有以某些扩展名结尾的文件
                String extension = cn.qqtheme.framework.util.FileUtils.getExtension(name);
                return cn.qqtheme.framework.util.ConvertUtils.toString(allowExtensions).contains(extension);
            }
