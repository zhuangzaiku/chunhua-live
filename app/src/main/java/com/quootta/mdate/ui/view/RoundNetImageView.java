...
public class RoundNetImageView extends ImageView {
    // 图片按下的画笔
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        // 获取控件的属性值
        if (attrs != null) {
            TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.RoundNetImageView);
            borderColor = array.getColor(R.styleable.RoundNetImageView_ml_border_color, borderColor);
            borderWidth = array.getDimensionPixelOffset(R.styleable.RoundNetImageView_ml_border_width, borderWidth);
            pressAlpha = array.getInteger(R.styleable.RoundNetImageView_ml_press_alpha, pressAlpha);
            pressColor = array.getColor(R.styleable.RoundNetImageView_ml_press_color, pressColor);
            radius = array.getDimensionPixelOffset(R.styleable.RoundNetImageView_ml_radius, radius);
            shapeType = array.getInteger(R.styleable.RoundNetImageView_ml_shape_type, shapeType);
            array.recycle();
        }
